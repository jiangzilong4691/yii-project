...
namespace common\service\IM\ImVendor\tencent;
...
class TLSSigAPIv2
{
     ...
     * @param   string  $base64_userbuf base64    编码后的 userbuf
     * @param   boolean $userbuf_enabled 是否开启 userbuf
     ...
     * @param   string  $userbuf_enabled      是否开启 userbuf
     * @return  string 签名字符串
     * @throws \Exception
     */
     ...
     *
     * @param   string  $identifier 用户账号
     * @param   int     $expire     过期时间，单位秒，默认 180 天 15,552,000
     * @return string 签名字符串
     * @throws \Exception
     */
