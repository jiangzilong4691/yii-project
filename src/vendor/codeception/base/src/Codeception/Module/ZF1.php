 ...
 * * dbConnection - current instance of Zend_Db_Adapter
 ...
 *          $this->getModule('ZF1')->dbConnection->beginTransaction();
 *      }
 *
 *      function _after($test) {
 *          $this->getModule('ZF1')->dbConnection->rollback();
 *      }
 * }
 * ?>
 * ```
...
class ZF1 extends Framework
{
    ...
    public function _before(TestInterface $test)
    {
        ...
        $db = $this->bootstrap->getBootstrap()->getResource('dbConnection');
