(function () {
    ...
    on(document.querySelectorAll('.dbConnection-explain a'), 'click', function (e) {
        ...
        var $explain = e.target.parentElement.parentElement.querySelector('.dbConnection-explain-text'),
            self = this;
    ...
    on(document.getElementById('db-explain-all').querySelector('a'), 'click', function () {
        ...
        document.querySelectorAll('.dbConnection-explain a').forEach(function (item) {
