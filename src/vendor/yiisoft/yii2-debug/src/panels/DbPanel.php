...
class DbPanel extends Panel
{
    ...
    /**
     * @var array dbConnection queries info extracted to array as models, to use with data provider.
     */
    private $_models;
    /**
    ...
    {
        $this->actions['dbConnection-explain'] = [
    ...
    public function getSummary()
    {
        ...
        return Yii::$app->view->render('panels/dbConnection/summary', [
            'timings' => $this->calculateTimings(),
            'panel' => $this,
    ...
    public function getDetail()
    {
        ...
        return Yii::$app->view->render('panels/dbConnection/detail', [
            'panel' => $this,
     ...
     * 'yii\dbConnection\Command::query', 'yii\dbConnection\Command::execute'.
     * @return array
     */
