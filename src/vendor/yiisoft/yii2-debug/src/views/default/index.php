...
<div class="yii-debug-main-container default-index">
    ...
    <div class="container-fluid">
        <div class="table-responsive">
            ...
            $hasDbPanel = isset($panels['dbConnection']);
            ...
            echo GridView::widget([
                ...
                'rowOptions' => function ($model) use ($searchModel, $hasDbPanel) {
                    ...
                    if ($hasDbPanel && $this->context->module->panels['dbConnection']->isQueryCountCritical($model['sqlCount'])) {
                        return ['class' => 'table-danger'];
                    }
                ...
                'columns' => array_filter([
                    ...
                    $hasDbPanel ? [
                        ...
                        'value' => function ($data) {
                            ...
                            $dbPanel = $this->context->module->panels['dbConnection'];

                            if ($dbPanel->isQueryCountCritical($data['sqlCount'])) {
                                $content = Html::tag('b', $data['sqlCount']) . ' ' . Html::tag('span', '&#x26a0;');

                                return Html::a($content, ['view', 'panel' => 'dbConnection', 'tag' => $data['tag']], [
