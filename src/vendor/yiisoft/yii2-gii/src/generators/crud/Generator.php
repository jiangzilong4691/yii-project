...
class Generator extends \yii\gii\Generator
{
    ...
    /**
     * @return string|null driver name of modelClass dbConnection connection.
     * In case dbConnection is not instance of \yii\dbConnection\Connection null will be returned.
     * @since 2.0.6
     */
