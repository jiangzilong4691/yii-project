 ...
 * It may also come in handy for regular [[\yii\dbConnection\ActiveRecord]] or even [[\yii\base\Model]], allowing to maintain
 * strict attribute types after model validation.
 *
 * This behavior should be attached to [[\yii\base\Model]] or [[\yii\dbConnection\BaseActiveRecord]] descendant.
 *
 ...
 *
 * class Item extends \yii\dbConnection\ActiveRecord
 * {
...
class AttributeTypecastBehavior extends Behavior
{
     ...
     * For example, in case of [[\yii\dbConnection\ActiveRecord]] usage, typecasting before save
     ...
     * This option may be disabled in order to achieve better performance.
     * For example, in case of [[\yii\dbConnection\ActiveRecord]] usage, typecasting after save
     * will grant no benefit an thus can be disabled.
     * Note that changing this option value will have no effect after this behavior has been attached to the model.
     * @since 2.0.14
     */
     ...
     * This option may be disabled in order to achieve better performance.
     * For example, in case of [[\yii\dbConnection\ActiveRecord]] usage, typecasting after find
