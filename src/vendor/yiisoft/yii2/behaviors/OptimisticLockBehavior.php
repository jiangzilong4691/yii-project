 ...
 * returned by [[\yii\dbConnection\BaseActiveRecord::optimisticLock()|optimisticLock()]].
 *
 ...
 * [[\yii\dbConnection\BaseActiveRecord::optimisticLock()|optimisticLock()]], remove the column name
 ...
 * enable optimistic lock in parent class by overriding [[\yii\dbConnection\BaseActiveRecord::optimisticLock()|optimisticLock()]],
...
class OptimisticLockBehavior extends AttributeBehavior
{
    ...
    /**
     * Returns the column name to hold the version value as defined in [[\yii\dbConnection\BaseActiveRecord::optimisticLock()|optimisticLock()]].
     * @return string the property name.
     * @throws InvalidCallException if [[\yii\dbConnection\BaseActiveRecord::optimisticLock()|optimisticLock()]] is not properly configured.
     * @since 2.0.16
     */
