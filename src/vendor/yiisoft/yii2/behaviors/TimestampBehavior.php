 ...
 *
 * ```php
 * use yii\dbConnection\Expression;
 *
 * public function behaviors()
 * {
 *     return [
 ...
 * ```
 *
 * In case you use an [[\yii\dbConnection\Expression]] object as in the example above, the attribute will not hold the timestamp value, but
 * the Expression object itself after the record has been saved. If you need the value from DB afterwards you should call
 * the [[\yii\dbConnection\ActiveRecord::refresh()|refresh()]] method of the record.
 *
