...
/**
 * ActiveDataFilter allows composing a filtering condition in a format suitable for [[\yii\dbConnection\QueryInterface::where()]].
 *
 * @see DataFilter
 *
...
class ActiveDataFilter extends DataFilter
{
    ...
    /**
     * @var array map filtering operators to operators used in [[\yii\dbConnection\QueryInterface::where()]].
     ...
     * used in [[\yii\dbConnection\QueryInterface::where()]]. However, you may want to adjust it in some special cases.
