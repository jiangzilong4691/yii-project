 ...
 * passed to [[\yii\dbConnection\Query::orderBy()]] to construct a DB query. This property is read-only.
 *
...
class Sort extends BaseObject
{
     ...
     * This can be passed to [[\yii\dbConnection\Query::orderBy()]] to construct a DB query.
     */
