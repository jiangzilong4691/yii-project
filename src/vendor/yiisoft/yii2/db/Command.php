 ...
 *
 * For more details and usage information on Command, see the [guide article on Database Access Objects](guide:dbConnection-dao).
 *
...
class Command extends Component
{
    ...
    /**
     * @var callable a callable (e.g. anonymous function) that is called when [[\yii\dbConnection\Exception]] is thrown
     ...
     * by its PHP type. You may explicitly specify the PDO type by using a [[yii\dbConnection\PdoValue]] class: `new PdoValue(value, type)`,
     ...
     * of [[yii\dbConnection\Query|Query]] to perform INSERT INTO ... SELECT SQL statement.
     * Passing of [[yii\dbConnection\Query|Query]] is available since version 2.0.11.
     * @return $this the command object itself
     */
     ...
     *     'visits' => 0,
     * ], [
     *     'visits' => new \yii\dbConnection\Expression('visits + 1'),
     * ], $params);
     * ```
     *
     ...
     * @param string $type the column type. [[\yii\dbConnection\QueryBuilder::getColumnType()]] will be called
    ...
    /**
     * Executes a dbConnection command resetting the sequence value of a table's primary key.
     ...
     *
     * ```php
     * function (\yii\dbConnection\Exception $e, $attempt)
     * {
