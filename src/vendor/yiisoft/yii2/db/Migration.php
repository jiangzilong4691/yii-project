 ...
 * applying migrations.
 *
 * For more details and usage information on Migration, see the [guide article on Migration](guide:dbConnection-migrations).
 *
...
class Migration extends Component implements MigrationInterface
{
     ...
     * This method will set [[dbConnection]] to be the 'dbConnection' application component, if it is `null`.
     */
    public function init()
    {
        parent::init();
     ...
     * This method executes the specified SQL statement using [[dbConnection]].
