 ...
 *
 * For more details and usage information on QueryBuilder, see the [guide article on query builders](guide:dbConnection-query-builder).
 *
 * @property string[] $conditionClasses Map of condition aliases to condition classes. For example: ```php
 * ['LIKE' => yii\dbConnection\condition\LikeCondition::class] ``` . This property is write-only.
...
class QueryBuilder extends \yii\base\BaseObject
{
     ...
     * ```php
     * return [
     *     'LIKE' => yii\dbConnection\condition\LikeCondition::class,
     * ];
     * ```
     *
     ...
     * ```php
     * [
     *    yii\dbConnection\Expression::class => yii\dbConnection\ExpressionBuilder::class
     * ]
     * ```
     ...
     * to instance of [[yii\dbConnection\condition\ConditionInterface|ConditionInterface]] according to
