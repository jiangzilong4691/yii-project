 ...
 * use yii\dbConnection\Connection;
 ...
 *     public $dbConnection;
 *
 *     public function __construct(Connection $dbConnection, $config = [])
 *     {
 ...
 * $container->set('yii\dbConnection\Connection', [
 *     'dsn' => '...',
 * ]);
 ...
 *
 * $dbConnection = new \yii\dbConnection\Connection(['dsn' => '...']);
 * $finder = new UserFinder($dbConnection);
...
class Container extends Component
{
     ...
     * $container->set('foo', 'yii\dbConnection\Connection');
     *
     ...
     * $container->set('dbConnection', [
     *     'class' => 'yii\dbConnection\Connection',
     *     'dsn' => 'mysql:host=127.0.0.1;dbname=demo',
     *     'username' => 'root',
     *     'password' => '',
     *     'charset' => 'utf8',
     ...
     * // The callable will be executed when $container->get('dbConnection') is called
     * $container->set('dbConnection', function ($container, $params, $config) {
     *     return new \yii\dbConnection\Connection($config);
     * });
     * ```
     *
