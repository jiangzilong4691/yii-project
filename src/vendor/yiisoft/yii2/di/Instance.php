 ...
 *     'dbConnection' => Instance::of('dbConnection')
 * ]);
 * $container->set('dbConnection', [
 *     'class' => 'yii\dbConnection\Connection',
 *     'dsn' => 'sqlite:path/to/file.dbConnection',
 * ]);
 * ```
 *
 ...
 *     {
 *         parent::init();
 *         $this->dbConnection = Instance::ensure($this->dbConnection, 'yii\dbConnection\Connection');
 *     }
 * }
 * ```
 *
...
class Instance
{
     ...
     *
     * // returns Yii::$app->dbConnection
     * $dbConnection = Instance::ensure('dbConnection', Connection::className());
     * // returns an instance of Connection using the given configuration
     * $dbConnection = Instance::ensure(['dsn' => 'sqlite:path/to/my.dbConnection'], Connection::className());
     * ```
     *
