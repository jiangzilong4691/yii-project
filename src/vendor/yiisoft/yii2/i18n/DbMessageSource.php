 ...
 *
 * The database connection is specified by [[dbConnection]]. Database schema could be initialized by applying migration:
 *
 * ```
...
class DbMessageSource extends MessageSource
{
     ...
     * @throws InvalidConfigException if [[dbConnection]] is invalid or [[cache]] is invalid.
     */
