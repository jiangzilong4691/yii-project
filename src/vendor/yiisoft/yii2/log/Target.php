...
abstract class Target extends Component
{
     ...
     * match those categories sharing the same common prefix. For example, 'yii\dbConnection\*' will match
     * categories starting with 'yii\dbConnection\', such as 'yii\dbConnection\Connection'.
     */
    public $categories = [];
    /**
