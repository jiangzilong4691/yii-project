...
class ExistValidator extends Validator
{
     ...
     * This can be a string or an array representing the additional query condition (refer to [[\yii\dbConnection\Query::where()]]
     * on the format of query condition), or an anonymous function with the signature `function ($query)`, where `$query`
     * is the [[\yii\dbConnection\Query|Query]] object that you can modify in the function.
     */
    public $filter;
    /**
     ...
     * [[\yii\dbConnection\Query::where()|Query::where()]] key-value format.
     *
     ...
     * @return array conditions, compatible with [[\yii\dbConnection\Query::where()|Query::where()]] key-value format.
